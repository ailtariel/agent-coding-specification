...
- **Action order:** Apply on the left, cancel/close on the right in LTR layouts; keep the primary action visually prominent and follow an explicit user-approved alternative
