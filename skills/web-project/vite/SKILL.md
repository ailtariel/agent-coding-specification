---
name: vite
description: Configure or troubleshoot Vite builds, plugins, dev servers, SSR, and version migrations.
metadata:
  author: Anthony Fu
  version: "2026.1.31"
...
> References include Vite 8 beta material. Confirm the installed version before applying version-specific APIs or migration guidance; this skill does not request an upgrade.
...
- Always use ESM, avoid CommonJS. This deliberate personal preference applies to code written for the task; it does not authorize unrelated conversions or override explicit project/runtime constraints.
